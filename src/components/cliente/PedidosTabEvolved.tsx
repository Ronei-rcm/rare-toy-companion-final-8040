            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl font-bold text-green-900">R$ {(stats.totalSpent || 0).toFixed(2)}</p>
                </div>
        ...
        <CardContent>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-white/60 p-4 rounded-lg">
              ...
              <p className="text-2xl font-bold text-green-700">R$ {(insights.averageOrderValue || 0).toFixed(2)}</p>
            </div>
            <div className="bg-white/60 p-4 rounded-lg">
              <div className="flex items-center gap-2 mb-2">
            ...
            <div className="bg-white/60 p-4 rounded-lg">
              ...
              <p className="text-2xl font-bold text-purple-700">R$ {(insights.totalSavings || 0).toFixed(2)}</p>
            </div>
            <div className="bg-white/60 p-4 rounded-lg">
              <div className="flex items-center gap-2 mb-2">
        ...
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                {viewMode === 'list' ? <PieChart className="w-4 h-4 mr-2" /> : <BarChart3 className="w-4 h-4 mr-2" />}
