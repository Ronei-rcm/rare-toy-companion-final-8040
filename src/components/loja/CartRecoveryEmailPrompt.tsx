            ...
            <Card className="bg-muted/30">
              <CardContent className="p-4">
                ...
                <div className="space-y-1 text-sm">
                  {recoveryData.items && Array.isArray(recoveryData.items) && recoveryData.items.slice(0, 3).map((item, index) => (
                  ...
                  {recoveryData.items && Array.isArray(recoveryData.items) && recoveryData.items.length > 3 && (
