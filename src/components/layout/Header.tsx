      ...
      >
        <div className="container max-w-7xl mx-auto">
          <div className="flex items-center justify-between gap-2">
            ...
            <Link to="/" onClick={() => haptics.light()} className="flex items-center space-x-2 flex-shrink-0 min-w-0 flex-1 lg:flex-none justify-center lg:justify-start">
              ...
              {user ? (
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button onClick={() => haptics.light()} className="relative inline-flex items-center justify-center h-9 w-9 sm:h-10 sm:w-10 rounded-full bg-gradient-to-r from-orange-500 to-pink-500 text-white hover:opacity-90 transition-opacity flex-shrink-0">
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem asChild>
                      <Link to="/minha-conta" onClick={() => haptics.light()}>Visão geral</Link>
                    </DropdownMenuItem>
                    <DropdownMenuItem asChild>
                      <Link to="/minha-conta?tab=pedidos" onClick={() => haptics.light()}>Meus pedidos</Link>
                    </DropdownMenuItem>
                    <DropdownMenuItem asChild>
                      <Link to="/minha-conta?tab=favoritos" onClick={() => haptics.light()}>Favoritos</Link>
                    </DropdownMenuItem>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem onClick={() => { haptics.medium(); handleLogout(); }}>Sair</DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>
              ) : (
                <Link
